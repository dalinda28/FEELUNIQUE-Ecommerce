 ...
 */
final class Version20210510084218 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE orders CHANGE user_id username_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_E52FFDEEED766068 ON orders');
        $this->addSql('ALTER TABLE orders CHANGE username_id user_id INT DEFAULT NULL');
